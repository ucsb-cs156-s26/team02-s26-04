...
describe("HelpRequestsCreatePage tests", () => {
  ...
  test("on submit, makes request to backend, and redirects to /helprequests", async () => {
    ...
    const helpRequest = {
      ...
      requestTime: "2021-01-01T00:00:00",
    ...
    fireEvent.change(tableOrBreakoutRoomInput, { target: { value: "1" } });
    fireEvent.change(requestTimeInput, {
      target: { value: "2021-01-01T00:00:00" },
    });
    ...
    expect(axiosMock.history.post[0].params).toEqual({
      ...
      teamId: "1",
      tableOrBreakoutRoom: "1",
      requestTime: "2021-01-01T00:00",
      explanation: "Test explanation",
      solved: false,
    });

    expect(mockToast).toBeCalledWith(
      "New help request Created - id: 3 requesterEmail: test@ucsb.edu teamId: 1 tableOrBreakoutRoom: 1 requestTime: 2021-01-01T00:00:00 explanation: Test explanation solved: false",
    );
