...
|---------------------------|--------------|-----------------|
| UCSBDiningCommonsMenuItem | Vanessa      |    vanessaxu07  |
| UCSBOrganization          | Annie        |     GuaziBai    |
| RecommendationRequest     | Ertan        |     Ertan10     |  
| MenuItemReview            | Tanvi        |     t-ladha     |  
| HelpRequest               | Erik         | ErikRodriguez29 |           
| Articles                  | Vincent      |  vincebnguyen   |  
